# Леста Старт: TF-IDF обработка текста"
...
## Замечания
Проект может содержать некоторые артефакты в виде неиспользуемых файлов и директорий, ~~а также следы орахиса яиц и сои...~~. Тем не менее это не влияет на работоспособность проекта.
